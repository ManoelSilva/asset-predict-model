...
class B3TrainingAPIClient:
    ...
    def train_complete(self, model_dir="models", n_jobs=5, test_size=0.2, val_size=0.2):
...
def main():
    ...
    try:
        ...
        print("python src/b3/service/b3_training_api.py")
        return
    ...
    # Example 3: Check final status
    print("=== Example 3: Final Status ===")
    try:
        status = client.get_status()
